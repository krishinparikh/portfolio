    ...
    <div className={styles.homeContainerWrapper}>
      ...
      <div className={styles.aboutSection}>
        <p>
            ...
            <br /><br />
            I loved turning my hobbies into side hustles. After seventh grade, I founded a summer camp to teach kids how to solve the Rubik's Cube, a skill I had honed to <a href="https://www.youtube.com/watch?v=2yrVTqqy4yc" target="_blank">under 15-second solve times</a>. I also built an e-commerce website to sell my <a href="https://www.youtube.com/watch?v=-atg20iRoEA" target="_blank">custom hip-hop beats</a>. The satisfaction of providing value to others through my own creations ignited a lifelong passion for entrepreneurship.
            <br /><br />
            ...
            <br /><br />
            I've continued my passion for startups as a selected <a href="https://case.edu/entrepreneurship/alumni-venture-fund" target="_blank">Alumni Venture Fellow</a>, where I've gotten the opportunity to source deals and make investments of up to $25,000 per company. In 2023, I was a selected <a href="https://case.edu/entrepreneurship/vealesnyderfellows" target="_blank">Veale Snyder Fellow</a>, allowing me to take fully funded trips to Silicon Valley, Las Vegas (for the Consumer Electronics Show), and Ireland to visit tech companies and network with professionals.
            <br /><br />
