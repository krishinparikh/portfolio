...
const EightPuzzle: React.FC = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.content}>This project was fun because it touched a little bit of several domains: algorithms, frontend development, and REST APIs. I'm excited to connect larger APIs in the future as I build larger systems. Additionally, this project inspired me to build an AI agent for another, far more difficult game: chess. This is currently a work in progress, but you can find the source code <a href="http://github.com/krishinparikh/chess/tree/dev" target="_blank">here</a>.</p>
    </div>
  );
};
