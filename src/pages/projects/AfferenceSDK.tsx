...
const AfferenceSDK: React.FC = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.content}>Co-founded by a serial entrepreneur and a neurotechnology expert, <a href="http://afference.io" target="_blank">Afference</a> is an early-stage startup aiming to bring the sense of touch—a core sensory experience—to virtual reality and smart wearables. Drawing from their expertise in neural engineering, Afference builds rings and gloves that create unique haptics in the fingertips by electrically stimulating the peripheral nervous system. Watch <a href="https://youtu.be/KGDWtPeMpDs?si=iZTiMGDsmiQvp4Cy" target="_blank">Freethink's Hard Reset video</a> to learn more about Afference.  
        <br /><br />
