...
import Commencement from '../assets/Commencement.jpg';
import VCIC from '../assets/VCIC.jpg';
  ...
  return (
    <div>
      ...
      <div className={styles.aboutContainer}>
        ...
        <p>
          That pattern continued the following year, when I turned a Rubik's Cube obsession into a summer camp, teaching kids to solve it — a skill I had honed to <a href="https://www.youtube.com/watch?v=2yrVTqqy4yc" target="_blank">under 15 seconds</a>. I also launched an e-commerce site selling <a href="https://www.youtube.com/watch?v=-atg20iRoEA" target="_blank">custom hip-hop beats</a> I'd produced in my bedroom.
        </p>
        ...
        <p>
            That Fellowship opened many doors, including my internship at <a href="http://afference.io" target="_blank">Afference</a>, a startup whose mission is to bring the sense of touch — a key aspect of human connection — to the digital world. I helped build and design a software development kit that will be deployed alongside Afference products, allowing software developers to integrate complex haptics into their digital experiences.
        </p>

        <p>
          Most recently, I led the development of an internal CRM platform for The O.H.I.O. Fund, from inception to launch. It reinforced my desire to not just write code behind a screen, but oversee the entire lifecycle of a product — including user research, design, coding, and continuous iteration.
        </p>

        <p>
          These days, I'm captivated by the opportunities of AI, especially in spaces that traditionally lack technical innovation. Drawing from my technical expertise and business/startup experience, I enjoy searching for and building high-value AI applications. Some projects include a <a href="/projects/curio" target="_blank">personalized education app</a>, a <a href="/projects/consultant-digital-mind" target="_blank">digital mind chatbot</a> for a consultant, and automations for podcast episode analysis and personalized networking.
        </p>
        ...
        <p>
            I love teaching and mentoring, not just to help others grow, but also to reinforce my own understanding of concepts. During high school summers, I was fortunate to teach STEM at the <a href="https://time2rise.org/" target="_blank">Time to Rise</a> summer program, shaping my own hands-on, practical curriculum for at-risk children. I've enjoyed volunteering children at <a href="https://idealist.org/en/nonprofit/e0c31efdb62448d686bd135188131234-lunch-buddies-at-bolton-elementary-cleveland" target="_blank">Bolton Elementary School</a> throughout college.
        </p>
