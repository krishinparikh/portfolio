export const frontmatter = {
  ...
  image: "/images/projects/tof-crm/logo.png",
  slug: "tof-crm",
  type: "project",
...
<FullImage src="/images/projects/tof-crm/low-fidelity.png" alt="Low Fidelity Mockup" />

Then, I moved onto the high-fidelity mockup. I created my own design system, taking inspiration from shadcn/ui components.

<div>
  <img src="/images/projects/tof-crm/high-fidelity-1.png" alt="High Fidelity Mockup 1" className="w-[48%] mr-[4%] shadow-md inline" />
  <img src="/images/projects/tof-crm/high-fidelity-2.png" alt="High Fidelity Mockup 2" className="w-[48%] shadow-md inline" />
</div>
<FullImage src="/images/projects/tof-crm/high-fidelity-3.png" alt="High Fidelity Mockup 3" className="mt-[4%]" />
...
<FullImage src="/images/projects/tof-crm/product-2.png" alt="CRM Page 2" />
...
<FullImage src="/images/projects/tof-crm/product-1.png" alt="CRM Page 1" />
