export const frontmatter = {
  ...
  image: "/images/projects/peer-ed/logo.png",
  slug: "peer-ed",
  type: "project",
...
<iframe
  src="https://docs.google.com/presentation/d/e/2PACX-1vSSRrkN4O4uCoyWmdUc2mtnck8I7WGSieF6JwyygaTt3M7Uu7wcI_TMzZiZ2Qi3g49GdLjmi-RgjgVP/embed?start=false&loop=false&delayms=5000"
  width="100%"
  height="485"
  allowFullScreen
...
While I stand a strong proponent of peer-to-peer learning, this idea was not a viable business model. In this form factor, we would not be providing enough value to schools to justify the costs required to run this program. After pitching our idea to administration at two Nashville independent schools, we decided to stop. Intriguingly, I have yet to come across a successful peer-to-peer learning platform, with the possible exception of [Schoolhouse](https://schoolhouse.world/) (founded by Sal Khan).
