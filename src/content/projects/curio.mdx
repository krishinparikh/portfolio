...
<FullImage src="/images/curio/Home.png" alt="Curio Home" className="mt-[4%]" />
<FullImage src="/images/curio/LearningSession.png" alt="Curio Learning Session" className="mt-[4%]" />
<FullImage src="/images/curio/Module.png" alt="Curio Module" className="mt-[4%]" />
...
<FullImage src="/images/curio/LowFidelity.png" alt="Low Fidelity Mockup" />

## Implementation

<FullImage src="/images/curio/Architecture.png" alt="Curio Architecture" />
